...
import lam.tutorials.libraryapp.TeacherMainActivity;
...
public class AccountFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnUpdateAcc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                User ouser = LibAppDatabase.getInstance(getContext()).userDAO().getUserById(id_user);
                ...
                if(ouser.getRole().equals(role)) {
                    ...
                    LibAppDatabase.getInstance(getContext()).userDAO().updateUser(ouser);
                }else{
